...
exports.create = async function (req, res) {
    try {
        ...
        res.status(500).json({ message: "Erreur de l'enregistrement du broker", error: error.message });
    }
};
...
exports.getAll = async function (req, res) {
    try {
        ...
        res.status(500).json({ message: "Erreur de récupération des brokers", error: error.message });
    }
};
...
exports.getOne = async function (req, res) {
    try {
        ...
        res.status(500).json({ message: "Erreur de récupération du broker", error: error.message });
    }
};